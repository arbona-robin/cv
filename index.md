...
# Robin Arbona
Fullstack Developer | Web Apps & Custom Platforms | TypeScript
...
- Technologies used: Next.js (SSG), Decap CMS.

### La Plateforme_ - Registration Portal
**Full Stack Developer** *(September 2025 - October 2025)*
- Developed a registration portal for managing extracurricular workshop and activity registrations.
- Implemented full-stack solution with user authentication and database integration.
- Technologies used: Next.js, Airtable API, Firebase Auth.

### Nick Öhlo - Portfolio Website
**Frontend Developer** *(July 2025)*
- Created a [static portfolio website](https://www.nickohlo.com) for illustrator and graphic designer Nick Öhlo.
...
- Technologies used: SSG, Decap CMS.
...
- Technologies used: Stripe API, Next.js, React.js, Node.js.

### OnlyChefs
**Full Stack Developer** *(November 2024 - December 2024)*
- Integrated Stripe Connect to enable chefs to monetize premium content.
- Technologies used: Stripe API, React.js, Node.js, Nest.js.

### MaCoBioS (European Project)
**Frontend Developer** *(August 2024 - October 2024)*
- Developed [interactive tools](https://iopr.vercel.app/en) for scientists and decision-makers, focused on blue Nature-based Solutions for climate change adaptation.
- Technologies used: Next.js, D3.js, FCM algorithm.

### Spill Studio - Mimem.ai
**Full Stack Developer** *(June 2024 - December 2024)*
- Built the [mimem.ai](https://www.mimem.ai/) web platform, a high-precision motion capture solution using multi-camera setup.
...
- Built backend services for "Buddy Arena" video game (client: Affyn).
- Technologies used: TypeScript, GraphQL, Playfab, Azure Functions, GitHub Actions CI/CD.

### Corellis - Global Design
**Full Stack Developer** *(September 2022 - April 2023)*
- Developed a business application for CMA CGM within a team of 10.
- Agile methodologies and CI/CD environments.
- Technologies used: Node.js, React.js.

### Patrice Pane - Interior Architect
**Web Developer** *(August 2022 - September 2022)*
- Created [website](https://www.patricepane.com/) and CMS for interior architect Patrice Pane.

### i-wantit - Wishlist App
**Full Stack Developer** *(September 2021 - August 2022)*
- Developed mobile apps (React Native) and backend APIs (Node.js, GraphQL).
- Built Chrome Extensions and web interfaces (React/Next.js).

### La Plateforme_
**Frontend Developer** *(April 2021 - January 2022)*
- Co-developed the [Club Top20](https://clubtop20.com/) website, connecting major businesses in the Aix-Marseille region.

### Selva Mojada
**Contractor** *(January 2019 - January 2020)*
- Managed construction of an eco-lodge on Colombia's Pacific coast.

### Onet Technologies
**Project Manager** *(May 2011 - March 2018)*
- Led project management for reactor pool reconstruction at Paluel 2.
- Agency Director and Project Manager responsibilities.
