...
**Web Developer** *(January 2025 - February 2025)*
- Developed a portfolio website for a motion designer.
- Built as a static site with a focus on visual presentation and performance.
- Project link: [https://marcello.pages.dev/](https://marcello.pages.dev/)
...
### La Plateforme_ - Association
**Full Stack Developer** *(November 2024 - January 2025)*
- Developed a full-stack registration portal for extracurricular activities.
- Built the frontend and API layer with Next.js, integrated with Airtable as backend/database.
- Technologies used: Next.js (Frontend & API), Airtable (Backend).
